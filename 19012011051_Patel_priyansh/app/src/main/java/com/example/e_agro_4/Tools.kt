...
class Tools : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonbuy.setOnClickListener{
            Toast.makeText(this,"Saw Buyed Successfully !", Toast.LENGTH_SHORT).show()
            sendNotification("Buyed Successfully", "Saw Buyed Successfully !")
        }
    }
