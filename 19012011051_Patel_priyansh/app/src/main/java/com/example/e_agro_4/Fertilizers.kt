...
class Fertilizers : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonbuy.setOnClickListener {
            Toast.makeText(this, "All Purpose Fertilizer Buyed Successfully !", Toast.LENGTH_SHORT).show()
            sendNotification("Buyed Successfully", "All Purpose Fertilizer Buyed Successfully !")
        }
    }
